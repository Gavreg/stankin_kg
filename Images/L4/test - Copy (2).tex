...
\begin{document}
	...
	\begin{tikzpicture}[ scale=1.2]
		...
		\begin{scope}[tdplot_main_coords]
			...
			\draw [-Latex, green ] (0,-1,0) -- ($10*(j)$);	
			\draw [-Latex, blue] (0,0,-1) -- ($8*(k)$) node [right] {$y$};
			
			\edef\n{4}
			\edef\f{10}
			\edef\aspect{1}		
			\edef\ctg{\fpeval{1 / tan (90 / 2)}}	
			...
			%%ПЛОСКОСТЬ-------------------------------------------------
			\MATRIXROW{MART}{a}{\ctg / \aspect}{0}{0}{0}
			\MATRIXROW{MART}{b}{0}{ (\f + \n) / (-\f + \n)  }{0}{ (2*\n*\f / (\n - \f))}
			\MATRIXROW{MART}{c}{0}{0}{\ctg}{0}
			\MATRIXROW{MART}{d}{0}{-1}{0}{0}
